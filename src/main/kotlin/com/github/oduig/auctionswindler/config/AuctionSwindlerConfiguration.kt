...
class AuctionSwindlerConfiguration() {
  ...
  @Bean
  fun cors(starterConfigProperties: AuctionSwindlerConfigProperties): CorsConfigProperties =
      starterConfigProperties.cors!!

  @Bean
  fun webClient(starterConfigProperties: AuctionSwindlerConfigProperties): WebClientConfigProperties =
...
// Async config
//  @Bean
//  fun webClient(starterConfigProperties: AuctionSwindlerConfigProperties): WebClient {
//    return WebClient.builder()
